    ...
    settings: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: '9:16', label: '9:16 (вертикаль)' },
          { value: '4:5', label: '4:5 (Instagram)' },
          { value: '5:4', label: '5:4 (ландшафт)' },
          { value: '3:2', label: '3:2 (фото)' },
          { value: '2:3', label: '2:3 (портрет)' },
          { value: '21:9', label: '21:9 (ультраширокий)' },
          { value: '9:21', label: '9:21 (высокий)' },
        ],
  ...
  // 7b. Outpainter (zsxkib)
  {
    ...
    settings: [
      ...
      },
      {
        ...
        type: 'number',
        default: 0,
        description: 'Расширение влево (пиксели, макс 2000)',
      },
      {
        name: 'extend_right',
        label: 'Extend Right',
        type: 'number',
        default: 0,
        description: 'Расширение вправо (пиксели, макс 2000)',
      },
      {
        name: 'extend_top',
        label: 'Extend Top',
        type: 'number',
        default: 0,
        description: 'Расширение вверх (пиксели, макс 2000)',
      },
      {
        name: 'extend_bottom',
        label: 'Extend Bottom',
        type: 'number',
        default: 0,
        description: 'Расширение вниз (пиксели, макс 2000)',
      },
      {
        name: 'steps',
        label: 'Steps',
