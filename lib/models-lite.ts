...
export const EDIT_MODELS_LITE: ModelLite[] = [
  { id: 'nano-banana-pro-edit', displayName: 'Nano Banana Pro', description: 'Редактирование с текстом на изображении. ⏱️ 1-2 мин', action: 'edit' },
...
export const VIDEO_CREATE_MODELS_LITE: ModelLite[] = [
  ...
  { id: 'kling-1.0-t2v-fal', displayName: 'Kling 1.0 T2V', description: 'Kling — генерация видео из текста', action: 'video_create' },
...
export const VIDEO_I2V_MODELS_LITE: ModelLite[] = [
  ...
  { id: 'kling-1.0-i2v-fal', displayName: 'Kling 1.0 I2V', description: 'Kling — анимация с первым и последним кадром', action: 'video_i2v' },
  { id: 'kling-2.6-motion-control-fal', displayName: 'Kling 2.6 Motion Control', description: 'Kling — перенос движений с видео на изображение', action: 'video_i2v' },
...
export const VIDEO_EDIT_MODELS_LITE: ModelLite[] = [
  ...
  { id: 'kling-o1-v2v-fal', displayName: 'Kling O1 V2V', description: 'Kling — генерация кадра по референсу', action: 'video_edit' },
  { id: 'kling-o1-edit-fal', displayName: 'Kling O1 Edit', description: 'Kling — редактирование видео текстом, замена персонажей', action: 'video_edit' },
