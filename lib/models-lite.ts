...
export const VIDEO_CREATE_MODELS_LITE: ModelLite[] = [
  ...
  { id: 'kling-1.0-t2v-fal', displayName: 'Kling 1.0 Standard', description: 'Kling — генерация видео из текста (стандарт)', action: 'video_create' },
  { id: 'kling-1.0-pro-t2v-fal', displayName: 'Kling 1.0 Pro', description: 'Kling — генерация видео из текста (премиум)', action: 'video_create' },
