...
export default function EditFeaturePage() {
  return (
    <DocsShell>
      ...
      {/* CTA */}
      <Link href="/?action=edit" className="inline-flex items-center gap-2 px-4 py-2 text-[13px] text-white border border-[#444] rounded-xl hover:border-white transition-colors">
        Попробовать →
      </Link>
