...
const FEATURES = [
  ...
  },
  {
    id: 'brainstorm',
    name: 'Brainstorm',
    description: 'Сравнение моделей на одном промпте',
    fullDescription: 'Сгенерируйте изображение по одному промпту сразу на нескольких моделях. Сравните результаты на бесконечном холсте и найдите идеальную модель для вашего стиля.',
    models: ['Все модели Image'],
    href: '/brainstorm',
  },
  {
    id: 'inpaint',
