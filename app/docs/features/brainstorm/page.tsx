  ...
  return (
    <DocsShell tableOfContents={TABLE_OF_CONTENTS}>
      ...
      <div className="p-6 bg-transparent rounded-2xl border border-[#2f2f2f] text-center">
        <Link href="/brainstorm" className="inline-block px-6 py-3 text-white border border-[#444] rounded-xl hover:border-white text-sm transition-colors transition-colors">
